...
const configs = [
  {
    ...
    sourceFiles: {
      ...
      electronMainDev: 'src-electron/electron-main.ts',
    },
    name: 'admin',
  },
]
export default defineConfig((ctx) => {
  ...
  const quasarConfig = configs.find((e) => e.name === name)
  console.log(`====== ${process.env.NAME || 'Admin'} ${process.env.ENV || 'dev'} =======`)
  return {
    ...quasarConfig,
    eslint: {
      // fix: true,
    ...
    build: {
      ...
      vitePlugins: [
        ...
        //     vueTsc: true,
        //     eslint: {
        //       lintCommand: 'eslint -c ./eslint.config.js "./src*/**/*.{ts,js,mjs,cjs,vue,tsx,jsx}"',
        //       useFlatConfig: true,
        //     },
        //   },
        //   { server: false },
    ...
    framework: {
      ...
      // Quasar plugins
      plugins: ['Dialog', 'Loading', 'Notify', 'LoadingBar', 'Meta'],
    },
